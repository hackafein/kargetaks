...
class Form(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        #self.engine.rootContext().setContextProperty("bataryam", batarya)
        #self.engine.rootContext().setContextProperty("kilometre", kilometre)
        #self.engine.rootContext().setContextProperty("sicaklik", sicaklik)
